				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											<form method="post" action="vreg.jsp">
											<input type="text" name="uname" class="email" placeholder="User Name" maxlength="10"  />
			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="h_theo_java.html" class="menu1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Theory Videos<!-- <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span> --></a></li>
					...
					<li><a href="h_prog_java.html" class="menu"><span class="glyphicon glyphicon-film glyphicon-king" aria-hidden="true"></span>Programming Videos<!-- <span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span> --></a></li>
					...
					<li><a href="#" class="notes-icon"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>Notes</a></li>
					<li><a href="#" class="assign-icon"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Assignments</a></li>
					<li><a href="#" class="books-icon"><span class="glyphicon glyphicon-bold" aria-hidden="true"></span>Books</a></li>
				  </ul>
				  <!-- script-for-menu -->
						<script>
					...
					<div class="side-bottom">
						...
						<div class="copyright">
							<p>Copyright © 2015 My Play. All Rights Reserved | Design by <a href="http://w3layouts.com/">ritzzi23</a></p>
						</div>
					</div>
				</div>
				        </div>
					...
					<div class="single-grid-right">
						...
						while(rs.next()){
							...
							<div class="col-md-7 single-right-grid-left">
								<a href="original.jsp?param=<%=link %>" ><iframe width="100%" src="https://www.youtube.com/embed/param=<%=link %>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
								</a>
								</div>
							<div class="col-md-5 single-right-grid-right">
								<a href="original.jsp?title=<%=titles %>&param=<%=link %>" class="title"><p><%=titles %></p></a>
